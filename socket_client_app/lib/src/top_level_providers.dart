...
final channelStreamProvider = StreamProvider.autoDispose(
  (ref) => ref.watch(_channelProvider).stream,
);

/// Send data to the channel sink
final addToSinkProvider =
    Provider.autoDispose.family<void, dynamic>((ref, data) {
